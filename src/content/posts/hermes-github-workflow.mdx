...
<table>
  ...
  <tbody>
    ...
    <tr><td><strong>Hermes retry</strong></td><td>Réessayer après un échec</td></tr>
    <tr><td><strong>Hermes review</strong></td><td>Review de code</td></tr>
    <tr><td><strong>Hermes fix all</strong></td><td>Corriger tous les problèmes</td></tr>
    <tr><td><strong>Hermes fix it</strong></td><td>Corriger un problème spécifique</td></tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr><td><strong>Hermes Agent</strong></td><td>Agent IA principal (systemd, standalone)</td></tr>
    <tr><td><strong>Hermes WebUI</strong></td><td>Interface web (Docker, in-process)</td></tr>
    <tr><td><strong>Traefik</strong></td><td>Reverse proxy, SSL Let's Encrypt</td></tr>
    <tr><td><strong>OpenCode</strong></td><td>Webhook gateway secondaire (port 4097)</td></tr>
    <tr><td><strong>Docker Compose</strong></td><td>Conteneurisation des services</td></tr>
  </tbody>
</table>
